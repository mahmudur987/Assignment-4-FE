    ...
    <div className="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
        ...
        <p className="text-lg text-gray-300 mb-8">
          Stay in control of your books and users with our simple, fast, and
          intuitive management system.
        </p>
        <a
          href="#"
          className="bg-[var(--background)] text-gray-900 hover:bg-yellow-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg"
        >
          Get Started
        </a>
      </div>
